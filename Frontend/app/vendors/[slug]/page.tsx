...
export default function VendorDetailPage() {
  ...
  async function fetchVendor() {
    try {
      ...
      // Use the vendor's actual numeric ID, not the slug string
              ...
              >
                ...
                <div style={{ padding: 14 }}>
                  ...
                  {qty > 0 && !p.is_service ? (
                    ...
                    // FIX: Service items route to booking page instead of adding to cart
                    <button onClick={() => router.push(`/book/${vendor.slug}`)} style={{
